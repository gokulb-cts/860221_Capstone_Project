...
public class FmsResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<FmsExceptionResponse> handleCommonException(Exception e, WebRequest request) {
		e.printStackTrace();
		FmsExceptionResponse fmsExceptionResponse = new FmsExceptionResponse(e.getMessage(),
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		FmsExceptionResponse fmsExceptionResponse = new FmsExceptionResponse("Validation Failed",
	...
	public ResponseEntity<FmsExceptionResponse> handleAccessDeniedException(Exception e, WebRequest request) {
		FmsExceptionResponse fmsExceptionResponse = new FmsExceptionResponse(e.getMessage(),
				request.getDescription(false), new Date());

		return new ResponseEntity<FmsExceptionResponse>(fmsExceptionResponse, HttpStatus.UNAUTHORIZED);
	}
